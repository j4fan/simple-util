...
import com.j4fan.simpleutils.util.RedisUtil;
...
public class TestRedis {
    ...
    public void secKill(){
        //设置库存
        jedis.mset("good","basketball","number","100","access","0","startflag","0");
        //if request come
        if(jedis.get("startflag").equals("0")){
            //秒杀活动尚未开始
        }else{
            if(jedis.get("access").equals(jedis.get("number"))){
                //停止秒杀
            }else{
                //开始秒杀
                jedis.incr("access");
